...
// Closing contact card, styled like the thing it offers: a WhatsApp chat.
// Pale green chat-wallpaper tones (deliberately not the brand purple, and
// distinct from the grey footer below), the Felix insignia as the chat
// avatar, and the call to action shaped as a message input bar — tap the
// input, start the conversation. Kept short so it costs little scroll,
    ...
    <section className="pb-[50px] md:pb-[70px]">
      <div className="px-4 md:px-[60px]">
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl border border-ink/5 bg-[#e9f5ee]"
        >
          {/* Soft green wash, heaviest behind the chat column */}
          <div
            aria-hidden
            className="absolute inset-0 bg-[radial-gradient(ellipse_70%_100%_at_85%_0%,rgba(37,211,102,0.16),transparent_60%)]"
          />

          <div className="relative grid items-center gap-8 p-6 md:grid-cols-2 md:gap-12 md:p-12">
            {/* Pitch */}
            ...
            <div className="mx-auto w-full max-w-sm">
              ...
              <div className="mt-3.5 space-y-2" aria-hidden>
                ...
                >
                  We’re open till 10:00 PM tonight, see you soon! 🛍️
                </motion.div>
                <motion.div
                  variants={fadeUp}
              ...
              >
                <span className="truncate text-sm font-medium text-ink/45 transition-colors duration-300 group-hover:text-ink/70">
