...
// box, and there is no headline: a row of greyed logos under the words
...
export default function OpeningSoonBand() {
  return (
    <section className="border-y border-ink/[0.08] bg-white py-5 md:py-7">
      <div className="px-4 md:px-[60px]">
        <div className="flex items-center gap-4">
          <p className="shrink-0 text-[10px] font-bold uppercase tracking-[0.24em] text-ink/50">
            {OPENING_SOON.eyebrow}
          </p>
          <span aria-hidden className="h-px flex-1 bg-ink/10" />
          <Link
            href={OPENING_SOON.href}
            className="shrink-0 text-[11px] font-bold uppercase tracking-[0.14em] text-primary transition-colors duration-300 hover:text-ink"
          >
            {OPENING_SOON.cta}
          </Link>
        </div>
